...
public class MateriaPrima implements Serializable {
	...
	public String toString() {
		return "MateriaPrima [id=" + id + ", nome=" + nome + ", quantidade=" + quantidade + ", tipo=" + tipo
				+ ", validade=" + validade + ", controlada=" + controlada + ", fornecedor=" + fornecedor + "]";
	}
